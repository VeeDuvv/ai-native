...
function _(l2, u2, t5) {
  ...
  if (arguments.length > 2 && (e3.children = arguments.length > 3 ? n.call(arguments, 2) : t5), "function" == typeof l2 && null != l2.defaultProps)
    for (o2 in l2.defaultProps)
      null == e3[o2] && (e3[o2] = l2.defaultProps[o2]);
...
function $() {
  for (var n2, u2, t5, r2, o2, f2, c5, s2 = 1; i.length; )
    i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (t5 = void 0, o2 = (r2 = (u2 = n2).__v).__e, f2 = [], c5 = [], u2.__P && ((t5 = d({}, r2)).__v = r2.__v + 1, l.vnode && l.vnode(t5), O(u2.__P, t5, r2, u2.__n, u2.__P.namespaceURI, 32 & r2.__u ? [o2] : null, f2, null == o2 ? S(r2) : o2, !!(32 & r2.__u), c5), t5.__v = r2.__v, t5.__.__k[t5.__i] = t5, z(f2, t5, c5), t5.__e != o2 && C2(t5)));
  $.__r = 0;
}
...
function P(n2, l2, u2, t5, i2) {
  ...
  if (a3)
    for (r2 = 0; r2 < s2; r2++)
      null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t5 && (t5 = S(e3)), B2(e3, e3));
  return t5;
}
...
function L(n2, l2, u2, t5) {
  ...
  if (null === f2 && null == n2.key || f2 && o2 == f2.key && e3 == f2.type && 0 == (2 & f2.__u))
    return u2;
  if (t5 > (null != f2 && 0 == (2 & f2.__u) ? 1 : 0))
    for (i2 = u2 - 1, r2 = u2 + 1; i2 >= 0 || r2 < l2.length; ) {
      if (i2 >= 0) {
        if ((f2 = l2[i2]) && 0 == (2 & f2.__u) && o2 == f2.key && e3 == f2.type)
          return i2;
        i2--;
      }
      if (r2 < l2.length) {
        if ((f2 = l2[r2]) && 0 == (2 & f2.__u) && o2 == f2.key && e3 == f2.type)
          return r2;
        r2++;
      }
    }
...
function j(n2, l2, u2, t5, i2) {
  ...
  n:
    if ("style" == l2)
      ...
      r2 = l2 != (l2 = l2.replace(f, "$1")), l2 = l2.toLowerCase() in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? l2.toLowerCase().slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t5 ? u2.u = t5.u : (u2.u = c, n2.addEventListener(l2, r2 ? a : s, r2)) : n2.removeEventListener(l2, r2 ? a : s, r2);
    else {
...
function O(n2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  n:
    if ("function" == typeof j2)
      try {
        if (b = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C3 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i2, t5.__c ? m3 = (h2 = u2.__c = t5.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b, M2) : (u2.__c = h2 = new x(b, M2), h2.constructor = j2, h2.render = D2), C3 && C3.sub(h2), h2.props = b, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = d({}, h2.__s)), d(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), y3 = h2.props, v2 = h2.state, h2.__v = u2, p2)
        ...
        if (u2.__v = null, c5 || null != o2)
          ...
          u2.__e = t5.__e, u2.__k = t5.__k;
        l.__e(n3, u2, t5);
      }
    else
      null == o2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = V(t5.__e, u2, t5, i2, r2, o2, e3, c5, s2);
...
function V(u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  if (null == x3)
    ...
    for (a3 in k2)
      d2 = k2[a3], "children" == a3 ? v2 = d2 : "dangerouslySetInnerHTML" == a3 ? h2 = d2 : "value" == a3 ? _2 = d2 : "checked" == a3 ? m3 = d2 : c5 && "function" != typeof d2 || b[a3] === d2 || j(u2, a3, d2, b[a3], o2);
    if (h2)
      c5 || y3 && (h2.__html == y3.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t5.__k = [];
    else if (y3 && (u2.innerHTML = ""), I("template" == t5.type ? u2.content : u2, w(v2) ? v2 : [v2], t5, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && S(i2, 0), c5, s2), null != e3)
      for (a3 = e3.length; a3--; )
        g(e3[a3]);
...
function B2(n2, u2, t5) {
  ...
  if (i2 = n2.__k)
    for (r2 = 0; r2 < i2.length; r2++)
      i2[r2] && B2(i2[r2], u2, t5 || "function" != typeof n2.type);
...
function J(l2, u2, t5) {
  ...
  for (o2 in l2.type && l2.type.defaultProps && (e3 = l2.type.defaultProps), u2)
    "key" == o2 ? i2 = u2[o2] : "ref" == o2 ? r2 = u2[o2] : f2[o2] = null == u2[o2] && null != e3 ? e3[o2] : u2[o2];
